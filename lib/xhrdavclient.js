...
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
var xhrdav = {HttpStatus:{CONTINUE:100, SWITCHING_PROTOCOLS:101, PROCESSING:102, OK:200, CREATED:201, ACCEPTED:202, NON_AUTHORITATIVE_INFORMATION:203, NO_CONTENT:204, RESET_CONTENT:205, PARTIAL_CONTENT:206, MULTI_STATUS:207, MULTIPLE_CHOICES:300, MOVED_PERMANENTLY:301, FOUND:302, SEE_OTHER:303, NOT_MODIFIED:304, USE_PROXY:305, TEMPORARY_REDIRECT:307, BAD_REQUEST:400, UNAUTHORIZED:401, PAYMENT_REQUIRED:402, FORBIDDEN:403, NOT_FOUND:404, METHOD_NOT_ALLOWED:405, NOT_ACCEPTABLE:406, PROXY_AUTHENTICATION_REQUIRED:407, 
REQUEST_TIMEOUT:408, CONFLICT:409, GONE:410, LENGTH_REQUIRED:411, PRECONDITION_FAILED:412, REQUEST_ENTITY_TOO_LARGE:413, REQUEST_URI_TOO_LONG:414, UNSUPPORTED_MEDIA_TYPE:415, REQUEST_RANGE_NOT_SATISFIABLE:416, EXPECTATION_FAILED:417, UNPROCESSABLE_ENTITY:422, LOCKED:423, FAILED_DEPENDENCY:424, INTERNAL_SERVER_ERROR:500, NOT_IMPLEMENTED:501, BAD_GATEWAY:502, SERVICE_UNAVAILABLE:503, GATEWAY_TIMEOUT:504, HTTP_VERSION_NOT_SUPPORTED:505, INSUFFICIENT_STORAGE:507, QUIRK_IE_NO_CONTENT:1223}};
xhrdav.HttpStatus.text = {100:"Continue", 101:"Switching Protocols", 102:"Processing", 200:"OK", 201:"Created", 202:"Accepted", 203:"None-Authoritive Information", 204:"No Content", 205:"Reset Content", 206:"Partial Content", 207:"Multi-Status", 300:"Multiple Choices", 301:"Moved Permanently", 302:"Found", 303:"See Other", 304:"Not Modified", 305:"Use Proxy", 307:"Redirect", 400:"Bad Request", 401:"Unauthorized", 402:"Payment Required", 403:"Forbidden", 404:"Not Found", 405:"Method Not Allowed", 
...
505:"HTTP Version not supported", 507:"Insufficient Storage", 1223:"Unknown"};
...
goog.string.path = {};
goog.string.path.join = function(a) {
  for(var b = arguments[0], c = 1;c < arguments.length;c++) {
    var d = arguments[c];
    goog.string.startsWith(d, "/") ? b = d : b += b == "" || goog.string.endsWith(d, "/") ? d : "/" + d
  }
  return b
};
goog.string.path.normalizePath = function(a) {
  if(a == "") {
    return"."
  }
  var b = "";
  goog.string.startsWith(a, "/") && (b = "/", goog.string.startsWith(a, "//") && !goog.string.startsWith(a, "///") && (b = "//"));
  for(var a = a.split("/"), c = [], d = 0;d < a.length;d++) {
    var e = a[d];
    e == "" || e == "." || (e != ".." || !b && !c.length || goog.array.peek(c) == ".." ? c.push(e) : c.pop())
  }
  return b + c.join("/") || "."
};
/*
...
xhrdav.utils = {};
xhrdav.utils.path = {};
xhrdav.utils.path.removeLastSlash = function(a) {
  return a.match(/^(.+)\/$/) ? RegExp.$1 : a
};
xhrdav.utils.path.addLastSlash = function(a) {
  return goog.string.endsWith(a, "/") ? a : a + "/"
};
xhrdav.utils.path.split = function(a) {
  a = goog.array.filter(a.split("/"), function(a) {
...
goog.exportSymbol("xhrdav.utils.path.removeLastSlash", xhrdav.utils.path.removeLastSlash);
goog.exportSymbol("xhrdav.utils.path.addLastSlash", xhrdav.utils.path.addLastSlash);
goog.exportSymbol("xhrdav.utils.path.split", xhrdav.utils.path.split);
goog.dom = {};
goog.dom.classes = {};
...
xhrdav.parser.DomParser.prototype.initialize = function(a, b, c) {
  goog.isDefAndNotNull(a) && a instanceof Document || goog.functions.error("Xml document is NOT GIVEN!!")();
  goog.isDefAndNotNull(b) || goog.functions.error("Parse handler is NOT GIVEN!!")();
  this.xml_ = goog.dom.xml.loadXml(goog.dom.xml.serialize(a).split("\n").join("")).documentElement;
  this.handler_ = b;
  goog.isDefAndNotNull(c) || (c = {});
  this.nsSeparator_ = c.nsSeparator || "$";
  this.textNodeName_ = c.textNodeName || "$t";
  this.attributePrefix_ = c.attributePrefix || "";
  return this
};
xhrdav.parser.DomParser.prototype.parse = function() {
  var a = this.xml_;
  this.handler_.startDocument();
  this.handler_.execute(this, a);
  this.handler_.endDocument();
  return this
};
xhrdav.parser.DomParser.prototype.parseDocument = function(a) {
  var b = {};
  if(a.nodeType == goog.dom.NodeType.ELEMENT) {
    goog.array.forEach(a.attributes, function(a) {
      var d = this.parseAttributeName_(a.nodeName);
      b[d] = a.nodeValue
    }, this)
  }else {
    if(a.nodeType == goog.dom.NodeType.TEXT) {
  ...
  a.hasChildNodes() && goog.array.forEach(a.childNodes, function(a) {
    var d = this.parseNodeName_(a.nodeName);
    if(goog.isDefAndNotNull(b[d])) {
      if(goog.typeOf(b[d]) != "array") {
        var e = b[d];
        b[d] = [];
        b[d].push(e)
      }
      b[d].push(this.parseDocument(a))
    }else {
      b[d] = this.parseDocument(a)
    }
  }, this);
  return b
};
xhrdav.parser.DomParser.prototype.parseAttributeName_ = function(a) {
  return this.attributePrefix_ + a.replace(/:/, this.nsSeparator_)
};
xhrdav.parser.DomParser.prototype.parseNodeName_ = function(a) {
  return a.replace(/:/, this.nsSeparator_).replace(/#text/, this.textNodeName_)
};
goog.exportSymbol("xhrdav.parser.DomParser", xhrdav.parser.DomParser);
goog.exportProperty(xhrdav.parser.DomParser.prototype, "initialize", xhrdav.parser.DomParser.prototype.initialize);
goog.exportProperty(xhrdav.parser.DomParser.prototype, "parse", xhrdav.parser.DomParser.prototype.parse);
goog.exportProperty(xhrdav.parser.DomParser.prototype, "parseDocument", xhrdav.parser.DomParser.prototype.parseDocument);
goog.disposable = {};
...
xhrdav.parser.DomHandler.prototype.disposeInternal = function() {
  xhrdav.parser.DomHandler.superClass_.disposeInternal.call(this);
  this.resources_ = null
};
...
xhrdav.parser.DomHandler.prototype.execute = function(a, b) {
  this.resources_ = a.parseDocument(b)
};
...
goog.exportProperty(xhrdav.parser.DomHandler.prototype, "startDocument", xhrdav.parser.DomHandler.prototype.startDocument);
goog.exportProperty(xhrdav.parser.DomHandler.prototype, "endDocument", xhrdav.parser.DomHandler.prototype.endDocument);
goog.exportProperty(xhrdav.parser.DomHandler.prototype, "execute", xhrdav.parser.DomHandler.prototype.execute);
goog.exportProperty(xhrdav.parser.DomHandler.prototype, "getObject", xhrdav.parser.DomHandler.prototype.getObject);
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
xhrdav.utils.domparse = {};
xhrdav.utils.domparse.parseXml = function(a) {
  var b = new xhrdav.parser.DomHandler;
  try {
    (new xhrdav.parser.DomParser).initialize(a, b).parse()
  }catch(c) {
    console.log("Error: " + c.message)
  }finally {
    a = b.getObject() || {}, b.dispose()
  }
  return a
};
goog.exportSymbol("xhrdav.utils.domparse", xhrdav.utils.domparse);
goog.exportSymbol("xhrdav.utils.domparse.parseXml", xhrdav.utils.domparse.parseXml);
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
goog.structs = {};
...
goog.debug.Trace_.Event_.prototype.toTraceString = function(a, b, c) {
  var d = [];
  b == -1 ? d.push("    ") : d.push(goog.debug.Trace_.longToPaddedString_(this.eventTime - b));
  ...
  d.push(c, this);
  this.totalVarAlloc > 0 && d.push("[VarAlloc ", this.totalVarAlloc, "] ");
  return d.join("")
};
...
goog.debug.Trace_.prototype.stopTracer = function(a, b) {
  ...
  d = b === 0 ? 0 : b ? b : this.defaultThreshold_;
  ...
  if(g < d) {
    for(d = this.events_.length - 1;d >= 0;d--) {
      if(this.events_[d] == e) {
  ...
  if(f) {
    goog.debug.Logger.logToProfilers("Stop : " + f.comment), f.totalVarAlloc = this.getTotalVarAlloc(), h && (h.varAlloc += f.totalVarAlloc - e.totalVarAlloc)
  }
  this.tracerOverheadEnd_ += goog.debug.Trace_.now() - c;
  return g
};
...
goog.debug.Trace_.prototype.getStat_ = function(a) {
  ...
  if(!b) {
    b = this.statPool_.getObject(), b.type = a, this.stats_.set(a, b)
  }
  return b
};
...
goog.debug.Trace_.prototype.toString = function() {
  ...
  for(d = 0;d < b.length;d++) {
    c = this.stats_.get(b[d]), c.count > 1 && a.push(" TOTAL ", c, "\n")
  }
...
goog.debug.Console.prototype.addLogRecord = function(a) {
  if(!this.filteredLoggers_[a.getLoggerName()]) {
    var b = this.formatter_.formatRecord(a), c = goog.debug.Console.console_;
    if(c && c.firebug) {
      switch(a.getLevel()) {
      ...
      c ? c.log(b) : window.opera ? window.opera.postError(b) : this.logBuffer_ += b
    }
  }
};
...
goog.debug.Console.autoInstall = function() {
  ...
  window.location.href.indexOf("Debug=true") != -1 && goog.debug.Console.instance.setCapturing(!0)
};
...
xhrdav.ext = {};
xhrdav.ext.string = {};
xhrdav.ext.string.LetterType = {LOWER:0, UPPER:1};
...
String.prototype.camelize = function(a) {
  var b = xhrdav.ext.string.LetterType;
  goog.isDef(a) || (a = {});
  if(!goog.isDefAndNotNull(a.firstLetter) || a.firstLetter > b.UPPER) {
    a.firstLetter = b.UPPER
  }
  var c = a.with_dasherize ? this.split("-").join("_") : this, d;
  a.firstLetter == b.LOWER ? d = goog.array.map(c.split("_"), function(a, b) {
    return b == 0 ? a.toLowerCase() : a.capitalize()
  }) : a.firstLetter == b.UPPER && (d = goog.array.map(c.split("_"), function(a) {
    return a.capitalize()
  }));
  c = a.with_dasherize ? d.join("-") : d.join("");
  return c = goog.array.reduce(c.split("/"), function(a, b, c) {
    return a + (c == 0 ? b : "." + b.capitalize())
  }, "")
};
goog.exportSymbol("xhrdav.ext.string.LetterType", xhrdav.ext.string.LetterType);
goog.exportProperty(String.prototype, "capitalize", String.prototype.capitalize);
goog.exportProperty(String.prototype, "dasherize", String.prototype.dasherize);
goog.exportProperty(String.prototype, "camelize", String.prototype.camelize);
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
/*
...
xhrdav.Conf.prototype.initialize_ = function() {
  ...
  goog.DEBUG ? this.logger_.setLevel(goog.debug.Logger.Level.ALL) : this.logger_.setLevel(goog.debug.Logger.Level.WARNING);
...
xhrdav.Conf.prototype.initializeErrorHandler_ = function() {
  var a = goog.bind(function(a) {
    this.logger_.warning(a.name || "Throws exception", a)
  }, this);
  this.errorHandler_ = new goog.debug.ErrorHandler(a);
  goog.net.XhrIo.protectEntryPoints(this.errorHandler_)
};
xhrdav.Conf.prototype.getErrorHandler = function() {
  goog.isDefAndNotNull(this.errorHandler_) || this.initializeErrorHandler_();
  return this.errorHandler_
};
xhrdav.Conf.prototype.getXhrMgrConfig = function() {
  return this.xmgr_
};
xhrdav.Conf.prototype.getLogger = function(a) {
  a && this.logger_.setLevel(a);
  return this.logger_
};
xhrdav.Conf.logging = function(a, b) {
  var c = xhrdav.Conf.getInstance().getLogger(), d = goog.isDefAndNotNull(b) && goog.isDef(c[b]) ? b : "info";
  if(a && a instanceof Object) {
    var e = {};
    goog.mixin(e, a);
    goog.object.forEach(e, function(a, b) {
      c[d](goog.string.subs("%s: %s", b, a))
    })
  }else {
    c[d](a)
  }
...
goog.exportProperty(xhrdav.Conf.prototype, "getXhrMgrConfig", xhrdav.Conf.prototype.getXhrMgrConfig);
goog.exportProperty(xhrdav.Conf.prototype, "getLogger", xhrdav.Conf.prototype.getLogger);
...
xhrdav.Errors.serialize = function(a) {
  return goog.json.parse(goog.json.serialize(a))
};
...
xhrdav.Errors.prototype.setRequest = function(a) {
  if(goog.object.getCount(a) > 0) {
    this.request = a
  }
};
xhrdav.Errors.prototype.addProps = function(a) {
  goog.object.getCount(a) > 0 && goog.array.extend(this.props, a)
};
goog.exportSymbol("xhrdav.Errors", xhrdav.Errors);
goog.exportProperty(xhrdav.Errors.prototype, "hasRequest", xhrdav.Errors.prototype.hasRequest);
goog.exportProperty(xhrdav.Errors.prototype, "hasProps", xhrdav.Errors.prototype.hasProps);
goog.exportSymbol("xhrdav.Errors.serialize", xhrdav.Errors.serialize);
goog.exportProperty(xhrdav.Errors.prototype, "serialize", xhrdav.Errors.prototype.serialize);
goog.exportProperty(xhrdav.Errors.prototype, "clear", xhrdav.Errors.prototype.clear);
goog.exportProperty(xhrdav.Errors.prototype, "setRequest", xhrdav.Errors.prototype.setRequest);
goog.exportProperty(xhrdav.Errors.prototype, "addProps", xhrdav.Errors.prototype.addProps);
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
xhrdav.Resource = function() {
  this.href = null;
  this.pathlist = [];
  this.protocol = this.status = null;
  this.statuscode = 0;
  this.contenttype = this.lastmodified = this.creationdate = this.resourcetype = this.statustext = null;
...
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
xhrdav.ResourceController = function(a) {
  a instanceof xhrdav.Resource || (a = goog.isDefAndNotNull(a) ? xhrdav.ResourceController.serialize(a, !0) : new xhrdav.Resource);
  goog.mixin(this, a);
  this.request_ = null
};
xhrdav.ResourceController.prototype.setRequest = function(a) {
  this.request_ = a
};
xhrdav.ResourceController.serialize = function(a, b) {
  var c;
  b ? c = new xhrdav.Resource : (c = {}, goog.mixin(c, new xhrdav.Resource));
  goog.object.forEach(a, function(a, b) {
    goog.object.containsKey(c, b) && goog.object.set(c, b, a)
  });
  return c
};
xhrdav.ResourceController.prototype.serialize = function(a) {
  return xhrdav.ResourceController.serialize(this, a)
};
xhrdav.ResourceController.prototype.setDestination = function(a) {
  this.destination_ = a
};
...
xhrdav.ResourceController.prototype.buildNewDestination_ = function() {
  if(goog.isDefAndNotNull(this.destination_)) {
    var a = xhrdav.utils.path.split(this.destination_);
    a[a.length - 1] != this.pathlist[this.pathlist.length - 1] && a.push(this.pathlist[this.pathlist.length - 1]);
    this.destination_ = a[0] == "/" ? a.join("/") : "/" + a.join("/")
  }
};
xhrdav.ResourceController.prototype.remove = function(a, b, c, d, e) {
  if("collection" == this.resourcetype) {
    this.destination_ = xhrdav.utils.path.addLastSlash(this.destination_)
  }
  this.request_ && this.request_.remove(this.href, a, b, c, d, e)
};
xhrdav.ResourceController.prototype.mkDir = function(a, b, c, d, e) {
  goog.isDefAndNotNull(this.href) || goog.functions.error("Not found Directory path: obj.href = directoryPath")();
  this.href = xhrdav.utils.path.addLastSlash(this.href);
  this.request_ && this.request_.mkDir(this.href, a, b, c, d, e)
};
xhrdav.ResourceController.prototype.copy = function(a, b, c, d, e) {
  this.buildNewDestination_();
  if("collection" == this.resourcetype) {
    this.destination_ = xhrdav.utils.path.addLastSlash(this.destination_)
  }
  this.request_ && this.request_.copy(this.href, this.destination_, a, b, c, d, e)
};
xhrdav.ResourceController.prototype.copyBeforeValidate = function(a, b, c, d, e) {
  goog.isDefAndNotNull(this.destination_) || goog.functions.error("Not found destination: obj.setDestination = destPath")();
  return this.copy(a, b, c, d, e)
};
xhrdav.ResourceController.prototype.move = function(a, b, c, d, e) {
  this.buildNewDestination_();
  if("collection" == this.resourcetype) {
    this.destination_ = xhrdav.utils.path.addLastSlash(this.destination_)
  }
  this.request_ && this.request_.move(this.href, this.destination_, a, b, c, d, e)
};
xhrdav.ResourceController.prototype.moveBeforeValidate = function(a, b, c, d, e) {
  goog.isDefAndNotNull(this.destination_) || goog.functions.error("Not found destination: obj.setDestination = destPath")();
  return this.move(a, b, c, d, e)
};
xhrdav.ResourceController.prototype.rename = function(a, b, c, d, e) {
  if("collection" == this.resourcetype) {
    this.destination_ = xhrdav.utils.path.addLastSlash(this.destination_)
  }
  this.request_ && this.request_.move(this.href, this.destination_, a, b, c, d, e)
};
xhrdav.ResourceController.prototype.renameBeforeValidate = function(a, b, c, d, e) {
  if(goog.isDefAndNotNull(this.destination_)) {
    var f = xhrdav.utils.path.split(this.destination_);
    f[f.length - 1] == this.pathlist[this.pathlist.length - 1] && goog.functions.error("Duplicate destination: obj.href and  obj.destination is same!!")()
  }else {
    goog.functions.error("Not found destination: obj.setDestination = destPath")()
  }
  return this.rename(a, b, c, d, e)
};
goog.exportSymbol("xhrdav.ResourceController", xhrdav.ResourceController);
goog.exportProperty(xhrdav.ResourceController.prototype, "setRequest", xhrdav.ResourceController.prototype.setRequest);
goog.exportSymbol("xhrdav.ResourceController.serialize", xhrdav.ResourceController.serialize);
goog.exportProperty(xhrdav.ResourceController.prototype, "serialize", xhrdav.ResourceController.prototype.serialize);
goog.exportProperty(xhrdav.ResourceController.prototype, "setDestination", xhrdav.ResourceController.prototype.setDestination);
goog.exportProperty(xhrdav.ResourceController.prototype, "getDestination", xhrdav.ResourceController.prototype.getDestination);
goog.exportProperty(xhrdav.ResourceController.prototype, "remove", xhrdav.ResourceController.prototype.remove);
goog.exportProperty(xhrdav.ResourceController.prototype, "mkDir", xhrdav.ResourceController.prototype.mkDir);
goog.exportProperty(xhrdav.ResourceController.prototype, "copy", xhrdav.ResourceController.prototype.copy);
goog.exportProperty(xhrdav.ResourceController.prototype, "copyBeforeValidate", xhrdav.ResourceController.prototype.copyBeforeValidate);
goog.exportProperty(xhrdav.ResourceController.prototype, "move", xhrdav.ResourceController.prototype.move);
goog.exportProperty(xhrdav.ResourceController.prototype, "moveBeforeValidate", xhrdav.ResourceController.prototype.moveBeforeValidate);
goog.exportProperty(xhrdav.ResourceController.prototype, "rename", xhrdav.ResourceController.prototype.rename);
goog.exportProperty(xhrdav.ResourceController.prototype, "renameBeforeValidate", xhrdav.ResourceController.prototype.renameBeforeValidate);
...
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
xhrdav.Client = function(a) {
  this.initialize_(a)
};
xhrdav.Client.prototype.initialize_ = function(a) {
  goog.isDefAndNotNull(a) || (a = {});
  var b = goog.Uri.parse(location);
  this.scheme_ = a.scheme || b.getScheme() || "http";
  this.domain_ = a.domain || b.getDomain();
  this.port_ = a.port || b.getPort();
  this.auth_ = a.auth
};
...
xhrdav.Client.prototype.setAuthCredentials = function(a) {
  this.auth_ = a
};
xhrdav.Client.prototype.clearAuthCredentials = function() {
  this.auth_ = null
};
xhrdav.Client.prototype.parseHeaders_ = function(a) {
  var b = {}, a = goog.array.filter(a.split(/\n/), function(a) {
    return!goog.string.isEmptySafe(a)
  });
  goog.array.forEach(a, function(a) {
    var d = a.split(": "), a = goog.string.trim(d.shift()), d = goog.string.trim(d.join(": "));
    b[a] = d
  });
  return b
};
xhrdav.Client.prototype.canParseXml = function() {
  return goog.isDef(this.parseXml) ? !0 : !1
};
xhrdav.Client.prototype.setXmlParseFunction = function(a) {
  goog.mixin(this, a)
};
xhrdav.Client.prototype.processRequest_ = function(a, b, c) {
  b && b instanceof Function && b(c);
  var b = c.target, c = this.parseHeaders_(b.getAllResponseHeaders()), d = b.getResponse("while(1);");
  goog.string.contains(c["Content-Type"], "xml") && (d = b.getResponseXml("while(1);"), this.canParseXml() && (d = this.parseXml(d)));
  a && a(b.getStatus() || 500, d, c)
};
xhrdav.Client.prototype.generateUrl_ = function(a) {
  xhrdav.Conf.logging({"Client#generateUrl_":a});
  return goog.Uri.create(this.scheme_, null, this.domain_, this.port_, a, null, null)
};
xhrdav.Client.prototype.setParameters_ = function(a, b) {
  goog.isDefAndNotNull(b) && !goog.object.isEmpty(b) && goog.object.forEach(b, function(b, d) {
    b instanceof Array && !goog.array.isEmpty(b) ? a.setParameterValues(d.camelize({with_dasherize:!0}), b) : goog.string.isEmptySafe(b) && a.setParameterValue(d.camelize({with_dasherize:!0}), b)
  });
  return a
};
xhrdav.Client.prototype.convertHeadersKeys_ = function(a) {
  var b = {};
  goog.isDefAndNotNull(a) && !goog.object.isEmpty(a) && goog.object.forEach(a, function(a, d) {
    var e = d.camelize({with_dasherize:!0});
    goog.object.set(b, e, a)
  });
  return b
};
xhrdav.Client.prototype.request_ = function(a, b, c, d, e) {
  goog.isDefAndNotNull(d) || (d = {});
  if(!goog.isDefAndNotNull(d.headers)) {
    d.headers = {}
  }
  var f = goog.object.get(d.headers, "Authorization");
  goog.isDefAndNotNull(f) || goog.object.set(d.headers, "Authorization", this.auth_);
  goog.isDefAndNotNull(d.xhrMgr) ? d.xhrMgr.send(d.xhrId || goog.string.createUniqueString(), b, a, d.body, d.headers, d.priority || 0, goog.bind(this.processRequest_, this, c, e), d.maxRetries || 1) : goog.net.XhrIo.send(b, goog.bind(this.processRequest_, this, c, e), a, d.body, d.headers)
};
xhrdav.Client.prototype.options = function(a, b, c, d) {
  goog.isDefAndNotNull(c) || (c = {});
  a = this.generateUrl_(goog.string.urlDecode(a || ""));
  this.setParameters_(a, c.query);
  c.headers = this.convertHeadersKeys_(c.headers || {});
  goog.object.extend(c.headers, {"Cache-Control":"no-cache"});
  this.request_("OPTIONS", a, b, c, d)
};
xhrdav.Client.prototype.head = function(a, b, c, d) {
  goog.isDefAndNotNull(c) || (c = {});
  a = this.generateUrl_(goog.string.urlDecode(a || ""));
  this.setParameters_(a, c.query);
  c.headers = this.convertHeadersKeys_(c.headers || {});
  goog.object.extend(c.headers, {"Cache-Control":"no-cache"});
  this.request_("HEAD", a, b, c, d)
};
xhrdav.Client.prototype.get = function(a, b, c, d) {
  goog.isDefAndNotNull(c) || (c = {});
  a = this.generateUrl_(goog.string.urlDecode(a || ""));
  this.setParameters_(a, c.query);
  c.headers = this.convertHeadersKeys_(c.headers || {});
  this.request_("GET", a, b, c, d)
};
xhrdav.Client.prototype.put = function(a, b, c, d, e) {
  goog.isDefAndNotNull(d) || (d = {});
  a = goog.string.isEmptySafe(a) && a.match(/^(.+)\/$/) ? this.generateUrl_(goog.string.urlDecode(RegExp.$1 || "")) : this.generateUrl_(goog.string.urlDecode(a || ""));
  this.setParameters_(a, d.query);
  d.headers = this.convertHeadersKeys_(d.headers || {});
  goog.object.extend(d.headers, {"Cache-Control":"no-cache"});
  d.body = b;
  this.request_("PUT", a, c, d, e)
};
xhrdav.Client.prototype.propfind = function(a, b, c, d) {
  goog.isDefAndNotNull(c) || (c = {});
  a = this.generateUrl_(goog.string.urlDecode(a || ""));
  this.setParameters_(a, c.query);
  c.headers = this.convertHeadersKeys_(c.headers || {});
  goog.object.extend(c.headers, {"Content-Type":"text/xml", Depth:goog.isDefAndNotNull(c.headers.Depth) ? c.headers.Depth : 0});
  goog.object.extend(c, {body:'<?xml version="1.0" encoding="UTF-8"?><D:propfind xmlns:D="DAV:"><D:allprop /></D:propfind>'});
  this.request_("PROPFIND", a, b, c, d)
};
xhrdav.Client.prototype.proppatch = function(a, b, c) {
  goog.isDefAndNotNull(c) || (c = {});
  this.setParameters_(this.generateUrl_(goog.string.urlDecode(a || "")), c.query);
  c.headers = this.convertHeadersKeys_(c.headers || {})
};
xhrdav.Client.prototype.lock = function(a, b, c, d) {
  goog.isDefAndNotNull(c) || (c = {});
  a = this.generateUrl_(goog.string.urlDecode(a || ""));
  this.setParameters_(a, c.query);
  c.headers = this.convertHeadersKeys_(c.headers || {});
  goog.object.extend(c.headers, {"Content-Type":"text/xml", Depth:goog.isDefAndNotNull(c.headers.Depth) ? c.headers.Depth : 0});
  goog.object.extend(c, {body:'<?xml version="1.0" encoding="UTF-8"?><D:lockinfo xmlns:D="DAV:">\n<D:lockscope><D:' + (c.scope || "exclusive") + " /></D:lockscope>\n<D:locktype><D:" + (c.type || "write") + " /></D:locktype>\n<D:owner></D:owner>\n</D:lockinfo>\n"});
  this.request_("LOCK", a, b, c, d)
};
xhrdav.Client.prototype.mkcol = function(a, b, c, d) {
  goog.isDefAndNotNull(c) || (c = {});
  a = goog.string.endsWith(a, "/") ? a : a + "/";
  a = this.generateUrl_(goog.string.urlDecode(a || ""));
  this.setParameters_(a, c.query);
  c.headers = this.convertHeadersKeys_(c.headers || {});
  this.request_("MKCOL", a, b, c, d)
};
xhrdav.Client.prototype._delete = function(a, b, c, d) {
  goog.isDefAndNotNull(c) || (c = {});
  a = this.generateUrl_(goog.string.urlDecode(a || ""));
  this.setParameters_(a, c.query);
  c.headers = this.convertHeadersKeys_(c.headers || {});
  this.request_("DELETE", a, b, c, d)
};
xhrdav.Client.prototype.copyOrMovePath_ = function(a, b, c, d, e, f) {
  goog.isDefAndNotNull(e) || (e = {});
  b = this.generateUrl_(goog.string.urlDecode(b || ""));
  this.setParameters_(b, e.query);
  e.headers = this.convertHeadersKeys_(e.headers || {});
  goog.object.extend(e.headers, {"Cache-Control":"no-cache", Destination:this.generateUrl_(goog.string.urlDecode(c || "")), Overwrite:e.headers.Overwrite ? "T" : "F"});
  this.request_(a, b, d, e, f)
};
xhrdav.Client.prototype.move = function(a, b, c, d, e) {
  this.copyOrMovePath_("MOVE", a, b, c, d, e)
};
xhrdav.Client.prototype.copy = function(a, b, c, d, e) {
  this.copyOrMovePath_("COPY", a, b, c, d, e)
};
goog.exportSymbol("xhrdav.Client", xhrdav.Client);
goog.exportProperty(xhrdav.Client.prototype, "hasAuthCredentials", xhrdav.Client.prototype.hasAuthCredentials);
goog.exportProperty(xhrdav.Client.prototype, "getAuthCredentials", xhrdav.Client.prototype.getAuthCredentials);
goog.exportProperty(xhrdav.Client.prototype, "setAuthCredentials", xhrdav.Client.prototype.setAuthCredentials);
goog.exportProperty(xhrdav.Client.prototype, "clearAuthCredentials", xhrdav.Client.prototype.clearAuthCredentials);
goog.exportProperty(xhrdav.Client.prototype, "canParseXml", xhrdav.Client.prototype.canParseXml);
goog.exportProperty(xhrdav.Client.prototype, "setXmlParseFunction", xhrdav.Client.prototype.setXmlParseFunction);
goog.exportProperty(xhrdav.Client.prototype, "options", xhrdav.Client.prototype.options);
goog.exportProperty(xhrdav.Client.prototype, "head", xhrdav.Client.prototype.head);
goog.exportProperty(xhrdav.Client.prototype, "get", xhrdav.Client.prototype.get);
goog.exportProperty(xhrdav.Client.prototype, "put", xhrdav.Client.prototype.put);
goog.exportProperty(xhrdav.Client.prototype, "propfind", xhrdav.Client.prototype.propfind);
goog.exportProperty(xhrdav.Client.prototype, "mkcol", xhrdav.Client.prototype.mkcol);
goog.exportProperty(xhrdav.Client.prototype, "_delete", xhrdav.Client.prototype._delete);
goog.exportProperty(xhrdav.Client.prototype, "move", xhrdav.Client.prototype.move);
goog.exportProperty(xhrdav.Client.prototype, "copy", xhrdav.Client.prototype.copy);
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
xhrdav.ResourceBuilder = function() {
  this.resources_ = this.rawData_ = null
};
xhrdav.ResourceBuilder.createCollection = function(a) {
  var b = new xhrdav.ResourceBuilder;
  b.rawData_ = a;
  b.convertRaw2Models();
  return b
};
xhrdav.ResourceBuilder.prototype.convertRaw2Models = function() {
  if(goog.isDefAndNotNull(this.rawData_.D$response)) {
    var a = [];
    goog.array.forEach(this.rawData_.D$response instanceof Array ? this.rawData_.D$response : [this.rawData_.D$response], function(b) {
      var c = new xhrdav.ResourceController;
      c.href = b.D$href.$t;
      c.pathlist = xhrdav.utils.path.split(c.href);
      if(!goog.string.startsWith(c.pathlist[c.pathlist.length - 1], ".")) {
        if(goog.isDefAndNotNull(b.D$propstat)) {
          b = b.D$propstat;
          c.status = b.D$status.$t || "HTTP/1.1 404 Not Found";
          var d = c.status.split(" ");
          c.protocol = d.shift();
          c.statuscode = parseInt(d.shift());
          c.statustext = d.join(" ");
          if(goog.isDefAndNotNull(b.D$prop)) {
            b = b.D$prop;
            if(goog.isDefAndNotNull(b.D$getcontenttype) && goog.isDefAndNotNull(b.D$getcontenttype.$t)) {
              c.contenttype = b.D$getcontenttype.$t
            }
            if(goog.isDefAndNotNull(b.lp1$getcontentlength) && goog.isDefAndNotNull(b.lp1$getcontentlength.$t)) {
              c.contentlength = parseInt(b.lp1$getcontentlength.$t)
            }
            if(goog.isDefAndNotNull(b.lp1$resourcetype) && goog.isDefAndNotNull(b.lp1$resourcetype.D$collection)) {
              c.resourcetype = "collection"
            }
            if(goog.isDefAndNotNull(b.lp1$creationdate) && goog.isDefAndNotNull(b.lp1$creationdate.$t)) {
              c.creationdate = new Date(b.lp1$creationdate.$t)
            }
            if(goog.isDefAndNotNull(b.lp1$getlastmodified) && goog.isDefAndNotNull(b.lp1$getlastmodified.$t)) {
              c.lastmodified = new Date(b.lp1$getlastmodified.$t)
            }
            if(goog.isDefAndNotNull(b.lp1$getetag) && goog.isDefAndNotNull(b.lp1$getetag.$t)) {
              c.etag = b.lp1$getetag.$t
            }
            if(goog.isDefAndNotNull(b.lp2$executable) && goog.isDefAndNotNull(b.lp2$executable.$t)) {
              c.executable = b.lp2$executable.$t == "T" ? !0 : !1
            }
          }
        }
        goog.array.extend(a, c)
      }
    });
    this.buildTree_(a)
  }
};
xhrdav.ResourceBuilder.prototype.buildTree_ = function(a) {
  goog.array.stableSort(a, function(a, c) {
    return a.pathlist.length - c.pathlist.length
  });
  this.resources_ = {};
  this.resources_.root = a.shift();
  this.resources_.childs = a.length > 0 ? a : []
};
...
xhrdav.ResourceBuilder.serialize = function(a, b) {
  var c = {}, d = a.childs;
  c.root = a.root.serialize(b);
  c.childs = goog.array.map(d, function(a) {
    return a.serialize(b)
  }) || [];
  return c
};
xhrdav.ResourceBuilder.prototype.serialize = function(a) {
  return xhrdav.ResourceBuilder.serialize(this.getResources(), a)
};
goog.exportSymbol("xhrdav.ResourceBuilder", xhrdav.ResourceBuilder);
goog.exportSymbol("xhrdav.ResourceBuilder.createCollection", xhrdav.ResourceBuilder.createCollection);
goog.exportProperty(xhrdav.ResourceBuilder.prototype, "convertRaw2Models", xhrdav.ResourceBuilder.prototype.convertRaw2Models);
goog.exportProperty(xhrdav.ResourceBuilder.prototype, "getRawData", xhrdav.ResourceBuilder.prototype.getRawData);
goog.exportProperty(xhrdav.ResourceBuilder.prototype, "getResources", xhrdav.ResourceBuilder.prototype.getResources);
goog.exportSymbol("xhrdav.ResourceBuilder.serialize", xhrdav.ResourceBuilder.serialize);
goog.exportProperty(xhrdav.ResourceBuilder.prototype, "serialize", xhrdav.ResourceBuilder.prototype.serialize);
...
goog.structs.Pool.prototype.getObject = function() {
  ...
  if(!(goog.isDefAndNotNull(this.lastAccess) && a - this.lastAccess < this.delay)) {
    ...
    if(b) {
      this.lastAccess = a, this.inUseSet_.add(b)
    }
    return b
  }
};
...
goog.structs.Pool.prototype.removeFreeObject_ = function() {
  for(var a;this.getFreeCount() > 0;) {
    if(a = this.freeQueue_.dequeue(), this.objectCanBeReused(a)) {
      break
    }else {
      this.adjustForMinMax()
    }
...
goog.structs.Pool.prototype.objectCanBeReused = function(a) {
  return typeof a.canBeReused == "function" ? a.canBeReused() : !0
};
...
goog.structs.Heap.prototype.insertAll = function(a) {
  ...
  if(a instanceof goog.structs.Heap) {
    if(b = a.getKeys(), c = a.getValues(), a.getCount() <= 0) {
...
goog.structs.Heap.prototype.remove = function() {
  ...
  if(!(b <= 0)) {
    return b == 1 ? goog.array.clear(a) : (a[0] = a.pop(), this.moveDown_(0)), c.getValue()
  }
};
goog.structs.Heap.prototype.peek = function() {
  var a = this.nodes_;
  return a.length == 0 ? void 0 : a[0].getValue()
};
...
goog.structs.Heap.prototype.moveUp_ = function(a) {
  for(var b = this.nodes_, c = b[a];a > 0;) {
...
goog.structs.PriorityPool.prototype.setDelay = function(a) {
  ...
  if(goog.isDefAndNotNull(this.lastAccess)) {
    goog.global.clearTimeout(this.delayTimeout_), this.delayTimeout_ = goog.global.setTimeout(goog.bind(this.handleQueueRequests_, this), this.delay + this.lastAccess - goog.now()), this.handleQueueRequests_()
  }
};
...
goog.structs.PriorityPool.prototype.handleQueueRequests_ = function() {
  for(var a = this.requestQueue_;a.getCount() > 0;) {
...
xhrdav.DavFs.prototype.initXhrMgr_ = function() {
  var a = xhrdav.Conf.getInstance().getXhrMgrConfig();
  this.xhrMgr_ = goog.isDefAndNotNull(a) && !goog.object.isEmpty(a) ? new goog.net.XhrManager(a.maxRetries || 1, a.headers || {}, a.minCount || 1, a.maxCount || 10, a.timeoutInterval || 0) : new goog.net.XhrManager
};
xhrdav.DavFs.prototype.getXhrManager = function() {
  return this.xhrMgr_
};
xhrdav.DavFs.prototype.setXhrManager = function(a) {
  if(a && a instanceof goog.net.XhrManager) {
    this.xhrMgr_ = a
  }
};
xhrdav.DavFs.prototype.createClient_ = function(a, b) {
  var c = xhrdav.Conf.getInstance(), d = new xhrdav.Client(a);
  d.setXmlParseFunction(goog.getObjectByName(c.xmlParseFuncObj));
  goog.object.set(this.clients_, b, d)
};
xhrdav.DavFs.prototype.getConnection = function(a) {
  if(goog.string.isEmptySafe(a)) {
    a = xhrdav.DavFs.DEFAULT_DAV_SITE_NAME
  }
  return this.clients_[a]
};
xhrdav.DavFs.prototype.addConnection = function(a, b) {
  if(goog.string.isEmptySafe(b)) {
    b = xhrdav.DavFs.DEFAULT_DAV_SITE_NAME
  }
  this.createClient_(a, b)
};
xhrdav.DavFs.prototype.getRequest = function(a) {
  goog.isDefAndNotNull(a) || (a = {});
  if(goog.string.isEmptySafe(a.davSiteName)) {
    a.davSiteName = xhrdav.DavFs.DEFAULT_DAV_SITE_NAME
  }
  var b = this.getConnection(a.davSiteName);
  goog.string.isEmptySafe(a.auth) || (a.authOverwrite || !b.hasAuthCredentials()) && b.setAuthCredentials(a.auth);
  if(!goog.isDefAndNotNull(a.xhrIo) || !(a.xhrIo instanceof goog.net.XhrIo || a.xhrIo instanceof goog.net.XhrManager)) {
    a.xhrIo = this.xhrMgr_
  }
  return new xhrdav.DavFs.Request(b, a.xhrIo)
};
xhrdav.DavFs.Request = function(a, b) {
  this.davSite_ = a;
  this.xhrIo_ = b
};
xhrdav.DavFs.Request.prototype.responseHandler_ = function(a, b, c, d, e, f, g) {
  b = b(c, e, f, g);
  goog.isDefAndNotNull(d) && goog.isObject(d) ? a.apply(d, b) : a(b)
};
xhrdav.DavFs.Request.prototype.contentReadHandler_ = function(a, b, c) {
  xhrdav.Conf.getInstance();
  var d = xhrdav.HttpStatus, e = new xhrdav.Errors, f = [];
  b != d.OK && e.setRequest({status:b, message:d.text[b], path:a});
  f.push(e);
  f.push(c);
  return f
};
xhrdav.DavFs.Request.prototype.existsHandler_ = function(a, b) {
  xhrdav.Conf.getInstance();
  var c = xhrdav.HttpStatus, d = new xhrdav.Errors, e = [];
  goog.array.contains([c.OK, c.CREATED, c.NO_CONTENT], b) || d.setRequest({status:b, message:c.text[b], path:a});
  e.push(d);
  e.push(d.hasRequest() ? !1 : !0);
  return e
};
xhrdav.DavFs.Request.prototype.simpleErrorHandler_ = function(a, b, c, d) {
  xhrdav.Conf.getInstance();
  var c = xhrdav.HttpStatus, e = new xhrdav.Errors, f = [];
  goog.array.contains([c.OK, c.CREATED, c.NO_CONTENT], b) || e.setRequest({status:b, message:c.text[b], path:a});
  f.push(e);
  b == c.CREATED && f.push(d.Location);
  return f
};
xhrdav.DavFs.Request.getListDirFromMultistatus = function(a, b) {
  goog.isDefAndNotNull(b) || (b = {});
  var c = xhrdav.ResourceBuilder.createCollection(a);
  b.hasCtrl ? (c = c.getResources(), goog.isDefAndNotNull(c.root) && c.root.setRequest(this), goog.array.isEmpty(c.childs) || goog.array.forEach(c.childs, function(a) {
    a.setRequest(this)
  })) : c = c.serialize(b.asModel);
  return c
};
xhrdav.DavFs.Request.prototype.updateRequestHandler_ = function(a, b, c, d, e, f, g) {
  goog.getObjectByName(a, this.davSite_).call(this.davSite_, b, c, goog.bind(this.responseHandler_, this, d, this.simpleErrorHandler_, b, f), e, g)
};
xhrdav.DavFs.Request.prototype.propfindRequestHandler_ = function(a, b, c, d, e, f) {
  e = goog.bind(this.processMultistatus_, this, e);
  this.davSite_.propfind(a, goog.bind(this.responseHandler_, this, b, e, a, d), c, f)
};
xhrdav.DavFs.Request.prototype.processMultistatus_ = function(a, b, c, d) {
  xhrdav.Conf.getInstance();
  var e = xhrdav.HttpStatus, f = new xhrdav.Errors, g = [];
  c == e.MULTI_STATUS ? d = xhrdav.DavFs.Request.getListDirFromMultistatus(d, a) : f.setRequest({status:c, message:e.text[c], path:b});
  g.push(f);
  g.push(d);
  return g
};
xhrdav.DavFs.Request.prototype.createRequestParameters_ = function(a, b, c) {
  a = {headers:a || {}, query:b || {}};
  goog.isDefAndNotNull(this.xhrIo_) && (this.xhrIo_ instanceof goog.net.XhrIo ? goog.object.extend(a, {xhrIo:this.xhrIo_}) : this.xhrIo_ instanceof goog.net.XhrManager && (c = goog.string.isEmptySafe(c) ? {xhrId:goog.string.createUniqueString(), xhrMgr:this.xhrIo_} : {xhrId:c, xhrMgr:this.xhrIo_}, goog.object.extend(a, c)));
  return a
};
xhrdav.DavFs.Request.prototype.listDir = function(a, b, c, d, e, f, g) {
  c = this.createRequestParameters_(c, d, f && f.xhrId);
  c.headers.Depth = 1;
  this.propfindRequestHandler_(a, b, c, e, f, g)
};
xhrdav.DavFs.Request.prototype.getProps = function(a, b, c, d, e, f, g) {
  c = this.createRequestParameters_(c, d, f && f.xhrId);
  this.propfindRequestHandler_(a, b, c, e, g)
};
xhrdav.DavFs.Request.prototype.mkDir = function(a, b, c, d, e, f, g) {
  c = this.createRequestParameters_(c, d, f && f.xhrId);
  this.davSite_.mkcol(a, goog.bind(this.responseHandler_, this, b, this.simpleErrorHandler_, a, e), c, g)
};
xhrdav.DavFs.Request.prototype.remove = function(a, b, c, d, e, f, g) {
  c = this.createRequestParameters_(c, d, f && f.xhrId);
  this.davSite_._delete(a, goog.bind(this.responseHandler_, this, b, this.simpleErrorHandler_, a, e), c, g)
};
xhrdav.DavFs.Request.prototype.move = function(a, b, c, d, e, f, g, h) {
  d = this.createRequestParameters_(d, e, g && g.xhrId);
  this.updateRequestHandler_("move", a, b, c, d, f, h)
};
xhrdav.DavFs.Request.prototype.copy = function(a, b, c, d, e, f, g, h) {
  d = this.createRequestParameters_(d, e, g && g.xhrId);
  this.updateRequestHandler_("copy", a, b, c, d, f, h)
};
xhrdav.DavFs.Request.prototype.read = function(a, b, c, d, e, f, g) {
  c = this.createRequestParameters_(c, d, f && f.xhrId);
  a = xhrdav.utils.path.removeLastSlash(a);
  this.davSite_.get(a, goog.bind(this.responseHandler_, this, b, this.contentReadHandler_, a, e), c, g)
};
xhrdav.DavFs.Request.prototype.write = function(a, b, c, d, e, f, g, h) {
  d = this.createRequestParameters_(d, e, g && g.xhrId);
  a = xhrdav.utils.path.removeLastSlash(a);
  this.davSite_.put(a, b, goog.bind(this.responseHandler_, this, c, this.simpleErrorHandler_, a, f), d, h)
};
xhrdav.DavFs.Request.prototype.upload = function(a, b, c, d, e, f, g, h) {
  d = this.createRequestParameters_(d, e, g && g.xhrId);
  a = xhrdav.utils.path.removeLastSlash(a);
  b instanceof File || (xhrdav.Conf.logging({"DavFs.Request#upload":'Argument "file" is not a file object!![path: ' + a + "]"}, "warning"), xhrdav.Conf.logging(b, "warning"));
  goog.isDefAndNotNull(b) && goog.object.extend(d.headers, {x_file_name:b.name, x_file_size:b.size});
  this.davSite_.put(a, b, goog.bind(this.responseHandler_, this, c, this.simpleErrorHandler_, a, f), d, h)
};
xhrdav.DavFs.Request.prototype.exists = function(a, b, c, d, e, f, g) {
  c = this.createRequestParameters_(c, d, f && f.xhrId);
  this.davSite_.head(a, goog.bind(this.responseHandler_, this, b, this.existsHandler_, a, e), c, g)
};
xhrdav.DavFs.Request.prototype.createResourceController = function(a) {
  a = new xhrdav.ResourceController(a);
  a.setRequest(this);
  return a
};
goog.exportSymbol("xhrdav.DavFs.getInstance", xhrdav.DavFs.getInstance);
goog.exportSymbol("xhrdav.DavFs.DEFAULT_DAV_SITE_NAME", xhrdav.DavFs.DEFAULT_DAV_SITE_NAME);
goog.exportProperty(xhrdav.DavFs.prototype, "getXhrManager", xhrdav.DavFs.prototype.getXhrManager);
goog.exportProperty(xhrdav.DavFs.prototype, "setXhrManager", xhrdav.DavFs.prototype.setXhrManager);
goog.exportProperty(xhrdav.DavFs.prototype, "getConnection", xhrdav.DavFs.prototype.getConnection);
goog.exportProperty(xhrdav.DavFs.prototype, "addConnection", xhrdav.DavFs.prototype.addConnection);
goog.exportProperty(xhrdav.DavFs.prototype, "getRequest", xhrdav.DavFs.prototype.getRequest);
goog.exportSymbol("xhrdav.DavFs.Request", xhrdav.DavFs.Request);
goog.exportSymbol("xhrdav.DavFs.Request.getListDirFromMultistatus", xhrdav.DavFs.Request.getListDirFromMultistatus);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "listDir", xhrdav.DavFs.Request.prototype.listDir);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "getProps", xhrdav.DavFs.Request.prototype.getProps);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "mkDir", xhrdav.DavFs.Request.prototype.mkDir);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "remove", xhrdav.DavFs.Request.prototype.remove);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "move", xhrdav.DavFs.Request.prototype.move);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "copy", xhrdav.DavFs.Request.prototype.copy);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "read", xhrdav.DavFs.Request.prototype.read);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "write", xhrdav.DavFs.Request.prototype.write);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "upload", xhrdav.DavFs.Request.prototype.upload);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "exists", xhrdav.DavFs.Request.prototype.exists);
goog.exportProperty(xhrdav.DavFs.Request.prototype, "createResourceController", xhrdav.DavFs.Request.prototype.createResourceController);
/*
 Copyright 2011 The xhrdavclient library authors. All rights reserved.
*/
